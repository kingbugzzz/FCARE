...
public class RPageUpdatePanel extends JPanel {
	...
	public RPageUpdatePanel(JDialog container, DashboardFrame dashboardFrame, RPage status) {
...
//				RPage status = new RPage();
				...
				container.dispose();
				dashboardFrame.loadPanel(new RPageMainPanel(dashboardFrame), "Quản lý status nguồn");
			}
		});
