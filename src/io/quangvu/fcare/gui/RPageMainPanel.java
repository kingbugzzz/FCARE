...
public class RPageMainPanel extends JPanel {
	...
	public RPageMainPanel(DashboardFrame container) {
		...
		btnXa.setIcon(new ImageIcon(RPageMainPanel.class.getResource("/io/quangvu/fcare/gui/icon/recycle-bin-recycle-16.png")));
		...
		btnCpNht.setIcon(new ImageIcon(RPageMainPanel.class.getResource("/io/quangvu/fcare/gui/icon/ic_mode_edit_48px-16.png")));
