...
public class RUidUpdatePanel extends JPanel {
	...
	public RUidUpdatePanel(JDialog container, DashboardFrame dashboardFrame, RUid status) {
...
//				RUid status = new RUid();
				...
				container.dispose();
				dashboardFrame.loadPanel(new RUidMainPanel(dashboardFrame), "Quản lý status nguồn");
			}
		});
