...
public class GroupJoinMainPanel extends JPanel {
	...
	public GroupJoinMainPanel(DashboardFrame container) {
		setLayout(null);
		...
		btnXa.setIcon(new ImageIcon(GroupJoinMainPanel.class.getResource("/io/quangvu/fcare/gui/icon/recycle-bin-recycle-16.png")));
		...
		btnCpNht.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				...
				if(selectedRowIndexes.length == 1) {
					...
					GroupJoinCampaign campaign = controller.get(String.valueOf(table.getValueAt(selectedRowIndexes[0], 0)));
					
					new GroupJoinUpdateDialog(container, "Cập nhật chiến dịch join group [id:" + campaign.getId() + "]", 830, 585, campaign).display();
				}else {
		...
		btnCpNht.setIcon(new ImageIcon(GroupJoinMainPanel.class.getResource("/io/quangvu/fcare/gui/icon/ic_mode_edit_48px-16.png")));
		...
		btnPlanlist.setIcon(new ImageIcon(GroupJoinMainPanel.class.getResource("/io/quangvu/fcare/gui/icon/settings_ico.png")));
